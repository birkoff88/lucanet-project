...
resource "aws_security_group" "sg" {
  ...
  ingress { description = "WireGuard"; from_port = 51820; to_port = 51820; protocol = "udp"; cidr_blocks = [var.my_ip_cidr] }
...
resource "aws_instance" "app" {
  ...
  root_block_device { volume_size = 20 } # 20GB safer for Docker images
